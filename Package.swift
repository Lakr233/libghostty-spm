...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.2.6/GhosttyKit.xcframework.zip",
            checksum: "3e9bb7768f5e1d57bd7d4ceb7b5f53a60673933b69758a36775390ceed60264d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
